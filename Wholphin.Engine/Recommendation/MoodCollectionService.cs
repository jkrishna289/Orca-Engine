...
/// clear a minimum size. Cached briefly so repeated home builds within a window reuse the work.
/// </summary>
public class MoodCollectionService : IMoodCollectionService
{
    ...
    /// </summary>
    public MoodCollectionService(IWholphinDbContextFactory factory, ICache cache)
    {
        _factory = factory;
        _cache = cache;
    }
